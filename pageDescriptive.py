                ...
                html.Div([
                    html.Div([
                       ...
                       makroDegiskenlerIleTuketimKorelasyonlari.makroDegiskenlerIleTuketimKorelasyonlari
                            ], style = {'background-color' : style.cardBackColor['back'],'box-shadow': '2px 5px 5px 1px rgba(30, 47, 123, .5)',"margin":"0rem","padding":"10px"})            
                ],className="col-xl-4"),
                html.Div([
                        html.Div([
                       # Makro degiskenler gelecek
                            makroDegiskenler.grafMakroDegiskenler
                        ],style = {'background-color' : style.cardBackColor['back'], 'box-shadow': '2px 5px 5px 1px rgba(30, 47, 123, .5)',"margin":"0rem","padding":"18px"})            
                ],className="col-xl-8",)
            ],className="row"),
...
html.Br([]),
            html.Div([
                    html.Div([
                       ...
                       # yeni grafik
                            ...
                            ], style = {'background-color' : style.cardBackColor['back'],'box-shadow': '2px 5px 5px 1px rgba(30, 47, 123, .5)',"margin":"0rem","padding":"20px"})            
                ],className="col-xl-12"),
            ...
            'box-shadow': '2px 5px 5px 1px rgba(30, 47, 123, .5)',"padding":"20px"})            
                ],className="col-xl-6",),
            html.Br([]),
                html.Div([
                    html.Div([
