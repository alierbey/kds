...
html.Div(html.Img(src=("assets/images/goal.jpeg"), style={"max-width":"100%", "height":"auto"})),
               ...
               html.Div([
                            html.Div([
                    html.H5("SENARYO 1"),
                    html.P("Dışa bağımlılık oranı istediğiniz bir değerde sabit tutarak enerji karmasının nasıl planlanması gerektiğiniz bulabilirsiniz."),
                    html.P("Elektrik üretimi için kullanılan kaynaklarda 2020 yılı itibariyle dışa bağımlılık oranı %43,6’dır."),
                    html.P("Lütfen planladığınız dışa bağımlılık oranını giriniz.",style={"text-align": "left","vertical-align":"middle", "margin":"10px"}),
                            html.Table([
                              html.Tr([
                                html.Td([html.P("%",style={"text-align": "right","vertical-align":"right", "margin":"1rem","padding":"8px"})], style={"text-align": "right","vertical-align":"right","padding":"1px"}),
                                html.Td([html.Div(dcc.Input(id='input-senaryo1-on-submit',value = 0,type='text', className="form-control", style={"color": "gray", "width" : "300px"} )),]),
                                html.Td([html.Button('Hesapla', id='submit-btn1-val', n_clicks=0, className = "btn btn-warning")]),

                              #   html.Div(id='container-button-basic',children='Enter a value and press submit')
                             ]),
                                 
                    ],style={"text-align": "center","vertical-align":"middle", "margin":"1rem","padding":"8px", "width": "500px"}),
                    html.Div(id='my-outputum1'),
                    html.Hr(),

                     html.H5("SENARYO 2"),
                     html.P("Beklenen talebi karşılamak için hangi oranda yenilenebilir enerji kaynağı kullanılacağını belirleyerek yatırım yapılması gereken enerji karışımını belirleyebilirsiniz. "),
                     html.P("Elektrik üretimi için kullanılan kaynaklarda 2020 yılı itibariyle yenilenebilir oranı %40,51’dir."),
                     html.P("Lütfen planladığınız yenilenebilir enerji oranını giriniz.   ",style={"text-align": "left","vertical-align":"middle", "margin":"10px"}),
                            html.Table([
                              html.Tr([
                                
                                html.Td([html.P("%",style={"text-align": "right","vertical-align":"right", "margin":"1rem","padding":"8px"})]),
                                html.Td([html.Div(dcc.Input(id='input-senaryo2-on-submit', value = 0,type='text', className="form-control", style={"color": "gray","width" : "300px"} )),]),
                    ...
                    html.Div(id='my-outputum2'),
                     ...
                     html.Hr(),
                     html.H5("SENARYO 3"),
                     html.P("Enerji arz güvenliğinin önemli göstergelerinden biri elektrik üretiminde kullanılan enerji çeşitliliğidir."),
                     html.P(" Mevcut durumda enerji çeşitliliği için hesaplanan entropi değeri 0,7533‘dür."),
                     html.P("Lütfen enerji çeşitliliğinin entropi değerini artırmak istediğiniz oranı giriniz. ",style={"text-align": "left","vertical-align":"middle", "margin":"10px"}),
                            html.Table([
                              html.Tr([
                                
                                html.Td([html.P("%",style={"text-align": "right","vertical-align":"right", "margin":"1rem","padding":"8px"})]),
                                html.Td([html.Div(dcc.Input(id='input-senaryo3-on-submit', value = 0,type='text', className="form-control", style={"color": "gray","width" : "300px"} )),]),
